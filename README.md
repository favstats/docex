...
<p align="center">
  <img src="https://img.shields.io/badge/tests-666%20passing-brightgreen" alt="Tests">
...
```bash
node --test test/*.test.js   # 666 tests should pass
```
...
docex/
  ...
  test/          32 test files, 666 passing tests
...
All 666 tests use Node.js built-in `node:test` and `node:assert`. No test framework needed.
